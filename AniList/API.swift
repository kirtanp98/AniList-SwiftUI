...
public final class GetMediaAltQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query getMediaAlt($id: Int, $type: MediaType, $isAdult: Boolean) {
  ...
  public let operationName: String = "getMediaAlt"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Medium: GraphQLSelectionSet {
      ...
      public struct CoverImage: GraphQLSelectionSet {
        ...
        public init(extraLarge: String? = nil, large: String? = nil) {
          self.init(unsafeResultMap: ["__typename": "MediaCoverImage", "extraLarge": extraLarge, "large": large])
        }
